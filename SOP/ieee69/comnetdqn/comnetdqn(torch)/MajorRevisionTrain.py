...
if train_mode:  
    ...
    for ep in range(EP_MAX):
        ...
        for t in range(EP_LEN):
            ...
            net5.put_data((state, a5, rewards[4], state_next, terminals[4]))
            net6.put_data((state, a6, rewards[5], state_next, terminals[5]))
            net7.put_data((state, a7, rewards[6], state_next, terminals[6]))
            # ===================================
