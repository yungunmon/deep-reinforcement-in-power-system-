...
#        return PV, WT, LOAD, Pline, Pbus, radial
        ...
        noV1, _, _, _, _, _  = self.noact(act1 = 1.0, act2 = acts2, act3 = acts3 , act4 = acts4, act5 = acts5, act6 = acts6 , act7 = acts7)
        ...
        self.rwd[1] = - (cost - nocostsop1)*100000    # dcline p (ess 69, 15)
        self.rwd[2] = (Vviol2 + Pbus2 - noV2)*10000      # dcline q (svc 69)
        self.rwd[3] = (Vviol3 + Pbus3 - noV3)*10000     # dcline q (svc 15)
        self.rwd[4] = - (cost - nocostsop2)*100000    # dcline p (ess 27, 54)
