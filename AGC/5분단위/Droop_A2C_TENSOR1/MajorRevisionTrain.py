...
if train_mode:
  for ep in range(EP_MAX):
    ...
    for t in range(EP_LEN):
      ...
      net8.put_data((state8, a8, rewards[7], state_next8, terminals[7]))
      net9.put_data((state9, a9, rewards[8], state_next9, terminals[8]))
    ...
    if train_mode:
      with open('./MajorRevision/reward3.csv', 'a', newline='') as mycsvfile:
          wr = csv.writer(mycsvfile)         
          wr.writerow([ep_r1])
else:
