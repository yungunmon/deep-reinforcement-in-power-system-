...
working_dir=r"C:\Users\yungun\Desktop\연구실\윤민한교수님+강화학습\연구" + os.sep
#-------------------------------------------------------------
#PSSE 실행
redirect.psse2py()
...
0.5254237288135593 ,0.5254237288135593 ,0.5084745762711864,0.38983050847457623 ] 
        ...
        self.Pdemand = 6097.1*self.LOAD[self.time]-600*(self.PV[self.time]+self.Wind[self.time])
        lam = 9
        ...
        #신재생에너지 
        psspy.load_data_6(3 ,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*PVcor,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(8 ,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*PVcor,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(16,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*PVcor,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(18,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*WTcor,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(23,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*WTcor,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(27,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*WTcor,_f,_f,_f,_f,_f,_f,_f],"")
    ...
    def noact(self, PV_,WT_):
        ...
        #신재생에너지 
        psspy.load_data_6(3 ,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*PV_,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(8 ,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*PV_,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(16,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*PV_,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(18,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*WT_,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(23,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*WT_,_f,_f,_f,_f,_f,_f,_f],"")
        psspy.load_data_6(27,r"""2""",[_i,_i,_i,_i,_i,_i,_i], [-200.0*WT_,_f,_f,_f,_f,_f,_f,_f],"")

        PVcor = self.PV[self.time+1]*(1+((np.random.rand()-0.5)*2)*0.1)
        WTcor = self.Wind[self.time+1]*(1+((np.random.rand()-0.5)*2)*0.3)
    ...
    def _step(self,acts, PV_,WT_):
        ...
        state30 = np.hstack([C30(lamb), Pdroop[0], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state32 = np.hstack([C32(lamb), Pdroop[1], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state33 = np.hstack([C33(lamb), Pdroop[2], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state34 = np.hstack([C34(lamb), Pdroop[3], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state35 = np.hstack([C35(lamb), Pdroop[4], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state36 = np.hstack([C36(lamb), Pdroop[5], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state37 = np.hstack([C37(lamb), Pdroop[6], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state38 = np.hstack([C38(lamb), Pdroop[7], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
        state39 = np.hstack([C39(lamb), Pdroop[8], self.LOAD[self.time+1], PVcor, WTcor]).flatten()
