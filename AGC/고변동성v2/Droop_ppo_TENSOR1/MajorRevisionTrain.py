...
if train_mode:
  for ep in range(EP_MAX):
    ...
    for t in range(EP_LEN):
      ...
      # print(rewards)
      # Train network ================================================================================================
      if (t + 1) % 60 == 0 or t == EP_LEN - 1 and train_mode:
        net1.train_net()
    ...
    if train_mode:
      with open('./MajorRevision/reward0906.csv', 'a', newline='') as mycsvfile:
          wr = csv.writer(mycsvfile)         
          wr.writerow([ep_r1])
else:
  ...
  for t in range(EP_LEN):
      ...
      with open(save_path +'validact3.csv', 'a', newline='') as mycsvfile:
        wr = csv.writer(mycsvfile)
        wr.writerow(ifo)
      with open(save_path +'pvwt3.csv', 'a', newline='') as mycsvfile:
        wr = csv.writer(mycsvfile)
        wr.writerow([PVcor,Wtcor])
