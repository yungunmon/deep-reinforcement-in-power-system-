...
def AGC(x,Pder):
    ...
    for i in range(len(generator)):
        x[i][0]=0.6*float(generator[0][1])/float(generator[0][2])
        x[i][i]=(-0.6*float(generator[i][1]))/float(generator[i][2])
        x[0][i]=1        
        z.append(0)        
    z.remove(0)     
    X= np.array(x)
...
0.5254237288135593 ,0.5254237288135593 ,0.5084745762711864,0.38983050847457623 ] 
    ...
    def noact(self, PV_,WT_):
        ...
        if self.time%5==0:
            lam = 8
            lam = ED(lam, self.Pdemand)
            self.lamb = copy.deepcopy(lam)
        Pdif = self.Pdemand - Pgen(self.lamb)
        
        Pdroop = AGC(generator, Pdif)

        psspy.case(sav_file)
        psspy.machine_chng_3(30,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(250, C30(self.lamb) + Pdroop[0]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(31,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(760, C31(self.lamb)            ) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(32,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(767, C32(self.lamb) + Pdroop[1]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(33,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(1068,C33(self.lamb) + Pdroop[2]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(34,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(982, C34(self.lamb) + Pdroop[3]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(35,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(987, C35(self.lamb) + Pdroop[4]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(36,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(932, C36(self.lamb) + Pdroop[5]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(37,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(882, C37(self.lamb) + Pdroop[6]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(38,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(1531,C38(self.lamb) + Pdroop[7]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(39,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(1090,C39(self.lamb) + Pdroop[8]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
    ...
    def _step(self,acts, PV_,WT_):
        ...
        if self.time%5==0:
            lam = 5
            lam = ED(lam, self.Pdemand)
            self.lamb1 = copy.deepcopy(lam)
        Pdif = self.Pdemand - Pgen(self.lamb1)
        ...
        psspy.case(sav_file)
        psspy.machine_chng_3(30,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(250, C30(self.lamb1) + Pdroop[0]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(31,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(760, C31(self.lamb1)            ) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(32,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(767, C32(self.lamb1) + Pdroop[1]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(33,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(1068,C33(self.lamb1) + Pdroop[2]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(34,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(982, C34(self.lamb1) + Pdroop[3]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(35,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(987, C35(self.lamb1) + Pdroop[4]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(36,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(932, C36(self.lamb1) + Pdroop[5]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(37,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(882, C37(self.lamb1) + Pdroop[6]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(38,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(1531,C38(self.lamb1) + Pdroop[7]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        psspy.machine_chng_3(39,r"""1""",[_i,_i,_i,_i,_i,_i,_i],[ min(1090,C39(self.lamb1) + Pdroop[8]) ,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
        ...
        state30 = np.hstack([C30(self.lamb1), Pdroop[0], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state32 = np.hstack([C32(self.lamb1), Pdroop[1], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state33 = np.hstack([C33(self.lamb1), Pdroop[2], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state34 = np.hstack([C34(self.lamb1), Pdroop[3], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state35 = np.hstack([C35(self.lamb1), Pdroop[4], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state36 = np.hstack([C36(self.lamb1), Pdroop[5], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state37 = np.hstack([C37(self.lamb1), Pdroop[6], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state38 = np.hstack([C38(self.lamb1), Pdroop[7], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        state39 = np.hstack([C39(self.lamb1), Pdroop[8], self.LOAD[(self.time+1)%self.MaxTime], PVcor, WTcor]).flatten()
        ...
        info = [a1.item(),a2.item(),a3.item(),a4.item(),a5.item(),a6.item(),a7.item(),a8.item(),a9.item(), TotalCost ,noactcost,TotalCost - noactcost, PV_, WT_]
        infoGEN = GEN
        infoPVWT = [PV_, WT_]
